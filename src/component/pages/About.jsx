    ...
    <div className="container-fluid my-5">
      <div className="card bg-black text-dark-emphasis  m-5">
        ...
        <p>
          ...
          “Verified Ratings.” For all other titles, we display an “All” score
          that includes ratings from people regardless of whether or not we can
          verify that they have seen the movie. Titles displaying Verified
          Ratings also have an All score. To view it, simply click on the
          popcorn bucket and you can toggle between the two.
        </p>
        <h2>Community & Critics Code of Conduct</h2>
        <p>
          At ZeeFlix, we are always looking to update our policies to try to
          ensure we maintain a safe and fair community for every movie and TV
          fan. For our Community Code of Conduct, click HERE. You can also find
          our Tomatometer-approved Critics Code of Conduct HERE.
        </p>
        <h2>Curation</h2>
        <p>
          <strong>ZeeFlix®</strong> has a team of curators whose job is to
          gather thousands of movie and TV reviews weekly. The team constantly
          collects movie and TV reviews from Tomatometer-approved critics and
          publications generating Tomatometer scores. Our curation process
          considers these reviews, noting if they are Fresh or Rotten, and our
          curators choose a representative pull-quote. Tomatometer-approved
